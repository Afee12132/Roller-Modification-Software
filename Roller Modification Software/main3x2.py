...
####绘图函数###################################################
    def hui1():
        ...
        s1 = qjbl.get_v('Dw')[:,int((int(Ys.get())+1)/2)]
        a1.plot(s1)
        canvas1.show()
    ...
    l3 = Label(f1_1,text='平直段母线长度',font=(10))
    l3.grid(row=3,column=0,padx=20,pady=8,sticky=W)
    Pl = StringVar()
    Pl.set(12)
    e3 = Entry(f1_1,textvariable=Pl)
    e3.grid(row=3,column=1)
    l3_3 = Label(f1_1,text='mm',font=(10))
    l3_3.grid(row=3,column=2,pady=8,sticky=W)
    
    l4 = Label(f1_1,text='大端直径 D',font=(10))
    l4.grid(row=4,column=0,padx=20,pady=8,sticky=W)
    D = StringVar()
    D.set(20)
    e4 = Entry(f1_1,textvariable=D)
    e4.grid(row=4,column=1)
    l4_4 = Label(f1_1,text='mm',font=(10))
    l4_4.grid(row=4,column=2,pady=8,sticky=W)
    
    l5 = Label(f1_1,text='小端直径 d',font=(10))
    l5.grid(row=5,column=0,padx=20,pady=8,sticky=W)
    d = StringVar()
    d.set(18)
    e5 = Entry(f1_1,textvariable=d)
    e5.grid(row=5,column=1)
    l5_5 = Label(f1_1,text='mm',font=(10))
    l5_5.grid(row=5,column=2,pady=8,sticky=W)
    
    l6 = Label(f1_1,text='滚子半锥角 θ',font=(10))
    l6.grid(row=6,column=0, padx=20,pady=8,sticky=W)
    θ = StringVar()
    θ.set(2)
    e6 = Entry(f1_1,textvariable=θ)
    e6.grid(row=6,column=1)
    l6_6 = Label(f1_1,text='°',font=(10))
    l6_6.grid(row=6,column=2,pady=8,sticky=W)
     
    l7 = Label(f1_1,text='弹性模量 E',font=(10))
    l7.grid(row=7,column=0,padx=20,pady=8,sticky=W)
    E = StringVar()
    E.set(200000)
    e7 = Entry(f1_1,textvariable=E)
    e7.grid(row=7,column=1)
    l7_7 = Label(f1_1,text='Mpa',font=(10))
    l7_7.grid(row=7,column=2,pady=8,sticky=W)
    
    l8 = Label(f1_1,text='泊松比 μ',font=(10))
    l8.grid(row=8,column=0,padx=20,pady=8,sticky=W)
    mo = StringVar()
    mo.set(0.3)
    e8 = Entry(f1_1,textvariable=mo)
    e8.grid(row=8,column=1)
    
    l9 = Label(f1_1,text='滚子轴向网格数 Xs',font=(10))
    l9.grid(row=9,column=0,padx=20,pady=8,sticky=W)
    Xs = StringVar()
    Xs.set(60)
    e9 = Entry(f1_1,textvariable=Xs)
    e9.grid(row=9,column=1)
    
    l10 = Label(f1_1,text='滚子径向网格数 Ys',font=(10))
    l10.grid(row=10,column=0,padx=20,pady=8,sticky=W)
    Ys = StringVar()
    Ys.set(40)
    e10 = Entry(f1_1,textvariable=Ys)
    e10.grid(row=10,column=1)
    
    l11 = Label(f1_1,text='施加载荷 F',font=(10))
    l11.grid(row=11,column=0,padx=20,pady=8,sticky=W)
    F = StringVar()
    F.set(1000)
    e11 = Entry(f1_1,textvariable=F)
    e11.grid(row=11,column=1)
    l11_11 = Label(f1_1,text='N',font=(10))
    l11_11.grid(row=11,column=2,pady=8,sticky=W)
    
    l12 = Label(f1_1,text='圆弧半径 R',font=(10))
    l12.grid(row=12,column=0, padx=20,pady=8,sticky=W)
    R = StringVar()
    R.set(900)
    e12 = Entry(f1_1,textvariable=R)
    e12.grid(row=12,column=1)
    l12_12 = Label(f1_1,text='mm',font=(10))
    l12_12.grid(row=12,column=2,pady=8,sticky=W)
    
    
    b = Button(f1_1,text='开始计算',command=lambda :yzhuiy.fun(float(cd.get()),float(D.get()),float(d.get()),float(yx.get()),float(θ.get()),float(E.get())
                  ,float(mo.get()),int(Xs.get()),int(Ys.get()),float(F.get()),float(R.get()),float(Pl.get()),f1,canvas1,f2,canvas2),fg='red')
    b.grid(row=13,column=0,columnspan=2,padx=30,pady=5,ipadx=25,)
    ...
    #########  绘图   ###################################
    f2_1 = Frame(Fr)
    f2_1.grid(row=0,column=1,pady=20,sticky=N,padx=30)
